...
class MathLibTest(unittest.TestCase):
    ...
    def test_gcd(self):
        ...
        #     [ -1, 1, 1 ], [ 1, -1, -1 ], [ -1, -1, -1 ],
        #     [ 0, 7, 7 ], [ 7, 0, 7 ], [ 0, 0, 0 ],
        #     [ 210, 30, 30 ], [ 210, 150, 30 ], [ 1000, 50, 50 ],
        # ]
        for a, b, expected, _ in MathLibTest.test_cases:
            g = MathLib.gcd(a, b)
            if verbose:
                print(f'gcd({a}, {b}) = {g}')
    ...
    def test_lcm(self):
        ...
        #     [ -1, 1, 1 ], [ 1, -1, 1 ], [ -1, -1, 1 ],
        #     [ 0, 7, 0 ], [ 7, 0, 0 ], [ 0, 0, 0 ],
        #     [ 210, 30, 210 ], [ 210, 150, 1050 ], [ 1000, 50, 1000 ],
        # ]
        for a, b, _, expected in MathLibTest.test_cases:
            l = MathLib.lcm(a, b)
            if verbose:
                print(f'lcm({a}, {b}) = {l}')
